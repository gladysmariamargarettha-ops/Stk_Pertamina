...
/// <summary>Representasi tabel "dokumen" — data dokumen STK yang sedang berlaku.</summary>
[Table("dokumen")]
public class Dokumen
{
    ...
    /// <summary>Masa berlaku dokumen dalam satuan tahun/bulan (dipakai untuk hitung kadaluarsa).</summary>
    [Column("kadaluarsa")]
